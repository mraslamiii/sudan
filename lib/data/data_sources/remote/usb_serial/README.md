...
3. پیام «اتصال شبیه‌سازی شد (بدون دستگاه USB فیزیکی)» را ببینید.
4. لیست طبقات و اتاق‌ها از میکرو (یا در حالت شبیه‌سازی از اسکریپت) گرفته می‌شود؛ در غیر این صورت کش خالی یا فقط اتاق «عمومی» نمایش داده می‌شود.

...
| **اپ روی تبلت واقعی** + تبلت با کابل/مبدل به لپ‌تاپ | **فقط یک پورت فیزیکی** روی لپ‌تاپ | مبدل USB-Serial به تبلت و لپ‌تاپ وصل است؛ لپ‌تاپ یک COM می‌بیند. شبیه‌ساز روی همان یک پورت اجرا می‌شود. com0com لازم نیست. |
...
| شبیه‌ساز        | `python usb_serial_simulator.py COM6` |
